...
if len(sys.argv) <= 2:
    print("Usage: pull-blobs.py BLOB_TYPE VERSION_CODE")
    sys.exit(1)
...
download_result = gapi.download('com.studiowildcard.wardrumstudios.ark', versionCode = arg_version, expansion_files = True)
