...
package_name: str = os.environ.get('gpAppPackageName')
...
if device_id == 0 or not device_codename or not auth_token or not package_name:
    print(
        "Some of these environmental variables are missing: gsfDeviceId, gsfDeviceCodename, gsfAuthToken, gpAppPackageName"
    )
    sys.exit(2)
